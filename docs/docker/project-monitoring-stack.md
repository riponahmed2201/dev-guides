...
- লগইন করুন: ইউজারনেম `admin`, পাসওয়ার্ড `admin` (প্রথমবার লগইনে পাসওয়ার্ড চেঞ্জ করতে বলবে)।

### গ্রাফানাতে প্রোমিথিউস কানেক্ট করা

- বাম মেনু থেকে **Connections** > **Data Sources** এ যান।
- **Add data source** এ ক্লিক করুন এবং **Prometheus** সিলেক্ট করুন।
- **Connection URL** বক্সে লিখুন: `http://prometheus:9090` (ডকার কম্পোজ কন্টেইনারের নাম)।
- নিচে স্ক্রল করে **Save & test** এ ক্লিক করুন। "Successfully queried the Prometheus API" মেসেজ আসলে সব ঠিক আছে।

### ড্যাশবোর্ড ইমপোর্ট করা

- এখন **Dashboards** > **New** > **Import** এ যান।
- আমরা "Node Exporter Full" ড্যাশবোর্ড ব্যবহার করব। এর আইডি হলো `1860`।
- **Import via grafana.com** টেক্সট বক্সে `1860` লিখে **Load** ক্লিক করুন।
- **Data source** ড্রপডাউন থেকে আপনার তৈরি করা Prometheus সোর্সটি সিলেক্ট করুন।
- **Import** এ ক্লিক করুন।
