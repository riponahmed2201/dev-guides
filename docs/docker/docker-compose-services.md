...
ডকার কম্পোজ ফাইলের সবচেয়ে গুরুত্বপূর্ণ অংশ হলো `services` ব্লক। এখানে আমরা প্রতিটি কন্টেইনারকে কিভাবে কনফিগার করা হবে, তা সুনির্দিষ্টভাবে লিখে থাকি। এই গাইডে আমরা সার্ভিসের বিভিন্ন কনফিগারেশন অপশনগুলো বিস্তারিত শিখবো।

---

## ১. সার্ভিস ডেফিনিশন (Service Definition)

প্রতিটি কন্টেইনারকে ডকার কম্পোজের ভাষায় একটি **Service** বলা হয়। একটি প্রজেক্টে অনেকগুলো সার্ভিস থাকতে পারে।

### ক) Building from Dockerfile
যদি আপনার ইমেজটি কাস্টম হয় এবং সেটি বিল্ড করার প্রয়োজন পড়ে:
```yaml
services:
  web:
...
## ৩. এনভায়রনমেন্ট ভ্যারিয়েবল (Environment Variables)

অ্যাপের পাসওয়ার্ড বা সিক্রেট কন্টেইনারের ভেতরে পাস করার দুটি পদ্ধতি আছে:
...
ডকার ইমেজে ডিফল্টভাবে যে কমান্ড দেওয়া থাকে (`CMD`), আপনি চাইলে কম্পোজ ফাইল থেকে তা পরিবর্তন করতে পারেন:
```yaml
services:
  app:
    image: my-node-app
...
কন্টেইনার কোনো কারণে ক্র্যাশ করলে বা বন্ধ হয়ে গেলে এটি কি অটো-স্টার্ট হবে কি না, তা এখান থেকে ঠিক করা যায়:

- `no`: অটোমেটিক রিস্টার্ট হবে না (ডিফল্ট)।
- `always`: সবসময় রিস্টার্ট হবে।
- `on-failure`: যদি এরর হয়ে বন্ধ হয়, তবেই রিস্টার্ট হবে।
- `unless-stopped`: ইউজার নিজে ম্যানুয়ালি স্টপ না করা পর্যন্ত অটো-রিস্টার্ট হবে।
...
| `environment` | কন্টেইনারে ভ্যারিয়েবল সেট করে |
