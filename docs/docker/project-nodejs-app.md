...
- `.dockerignore` ব্যবহার করে `node_modules` বাদ দেওয়া।
- কন্টেইনার বিল্ড এবং টেস্ট করা।

## ১. প্রজেক্ট সেটআপ
প্রথমে একটি ফোল্ডার তৈরি করুন এবং সেখানে `npm init` দিয়ে প্রজেক্ট শুরু করুন:
...
# প্রথমে package.json কপি করছি যাতে ক্যাশিং সুবিধা পাওয়া যায়
COPY package*.json ./
RUN npm install
...
## ৬. টেস্ট করা
আপনার ব্রাউজার বা Postman এ গিয়ে হিট করুন: `http://localhost:3000`
...
## সারাংশ
এই প্রজেক্টে আমরা শিখলাম কীভাবে একটি ডাইনামিক অ্যাপ্লিকেশন (Node.js) কন্টেইনারাইজ করতে হয়। বিশেষ করে `COPY package*.json ./` টেকনিকটি লেয়ার ক্যাশিং এর জন্য খুবই গুরুত্বপূর্ণ।
