...
1.  **Scaling (স্কেলিং):** ট্রাফিক বাড়লে অটোমেটিকভাবে একই কনটেইনারের একাধিক কপি তৈরি করা।
2.  **High Availability (হাই অ্যাভেইল্যাবিলিটি):** কোনো একটি সার্ভার বা কনটেইনার ফেইল করলে সাথে সাথে অন্যটি চালু করা।
3.  **Scheduling (শিডিউলিং):** কনটেইনারটি কোন সার্ভারে চলবে (যেখানে রিসোর্স বেশি আছে) তা স্বয়ংক্রিয়ভাবে নির্ধারণ করা।
4.  **Service Discovery & Load Balancing:** কনটেইনারগুলো একে অপরের সাথে কীভাবে যোগাযোগ করবে এবং ইনকামিং ট্রাফিক কীভাবে ভাগ হবে তা ম্যানেজ করা।
5.  **Self-Healing:** যদি কোনো কনটেইনার ক্র্যাশ করে, তবে অর্কেস্ট্রেশন টুল সেটি রিস্টার্ট করে বা নতুন একটি তৈরি করে।
6.  **Resource Management:** CPU এবং RAM-এর সঠিক ব্যবহার নিশ্চিত করা।
...
পরবর্তী অধ্যায়গুলোতে আমরা **Docker Swarm** সম্পর্কে বিস্তারিত জানব।
