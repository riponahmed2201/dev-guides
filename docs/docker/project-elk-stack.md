...
১. ব্রাউজারে যান: `http://localhost:5601`
২. **Management** > **Stack Management** > **Index Patterns** এ যান।
৩. **Create index pattern** এ ক্লিক করুন।
৪. লিখুন: `docker-logs-*` (আমরা Logstash কনফিগে এই ইনডেক্স প্যাটার্ন দিয়েছিলাম)।
৫. **Timestamp field** হিসেবে `@timestamp` সিলেক্ট করুন এবং **Create index pattern** এ ক্লিক করুন।
