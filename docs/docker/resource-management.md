...
- **Swap Limit (--memory-swap):** RAM এর সাথে কতটুকু সোয়াপ মেমোরি ব্যবহার করতে পারবে।
  ...
  ```
  _(এখানে কন্টেইনারটি ৫১২ মেগাবাইট র্যাম এবং অতিরিক্ত ৫১২ মেগাবাইট সোয়াপ ব্যবহার করতে পারবে, মোট ১ জিবি।)_
...
- **CPU Limit (--cpus):** কন্টেইনার কতটি CPU কোর ব্যবহার করতে পারবে।
  ...
  _(এটি ২ টি কোর ব্যবহার করার পারমিশন দেবে।)_

- **CPU Weight (--cpu-shares):** রিসোর্স ক্রাইসিস বা চাপের সময় কোন কন্টেইনার বেশি অগ্রাধিকার পাবে তা ঠিক করে।
  ```bash
  docker run -d --cpu-shares 512 nginx
  ```
  _(ডিফল্ট ভ্যালু ১০২৪। ৫১২ দিলে এটি অন্য কন্টেইনারের তুলনায় অর্ধেক প্রায়োরিটি পাবে।)_
