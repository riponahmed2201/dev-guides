...
1. একটি **GitHub Account** এবং একটি রিপোজিটরি।
2. একটি **Docker Hub Account** (যেখানে ইমেজ পুশ হবে)।
3. আপনার লোকাল মেশিনে একটি স্যাম্পল প্রোজেক্ট (যেমন আমাদের আগের Node.js অ্যাপটি)।
...
3. **New repository secret** বাটনে ক্লিক করুন এবং নিচের দুটি সিক্রেট অ্যাড করুন:
...
## ৪. টেস্ট করা
1. আপনার কোড গিটহাবে পুশ করুন:
   ```bash
   git add .
   git commit -m "Added CI/CD workflow"
   git push origin main
   ```
2. গিটহাব রিপোজিটরির **Actions** ট্যাবে যান।
3. দেখবেন আপনার নতুন ওয়ার্কফ্লো রান হচ্ছে।
4. সফল হলে, Docker Hub এ গিয়ে চেক করুন। দেখবেন `my-node-app` নামে একটি নতুন ইমেজ পুশ হয়েছে।
