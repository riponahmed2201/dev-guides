...
1. অ্যারের সব এলিমেন্টকে এক ঘর করে ডান দিকে (ডান ইনডেক্সে) সরিয়ে ফেলুন।
2. প্রথম ইনডেক্সটি (Index 0) খালি হলে সেখানে নতুন এলিমেন্টটি বসিয়ে দিন।
...
2. তার ডান পাশের সব এলিমেন্টকে এক ঘর বামে (বাম ইনডেক্সে) সরিয়ে নিয়ে আসুন।
3. অ্যারের সাইজ ১ কমিয়ে দিন।
...
1. দুটি পয়েন্টার নিন: `start` (শুরুতে) এবং `end` (শেষে)।
2. `start` এবং `end` এর ভ্যালু অদলবদল (Swap) করুন।
3. `start` এক ঘর বাড়ান এবং `end` এক ঘর কমান।
4. `start < end` যতক্ষণ থাকবে, ততক্ষণ এটি চালিয়ে যান।
