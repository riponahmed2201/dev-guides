...
1. একটি `dp` অ্যারে নিন যার সাইজ হবে স্ট্রিংয়ের দৈর্ঘ্যের চেয়ে ১ বেশি। `dp[0]` কে `true` মার্ক করুন।
2. দুটি লুপ চালান: `i` (১ থেকে n পর্যন্ত) এবং `j` (০ থেকে i পর্যন্ত)।
3. যদি `dp[j]` সত্য হয় এবং `s[j:i]` ডিকশনারিতে থাকে, তবে `dp[i]` কে `true` মার্ক করুন।
...
1. স্ট্রিংটি লুপ চালিয়ে ট্রাভার্স করুন।
2. পাশাপাশি দুটি ক্যারেক্টার চেক করুন। যদি একই হয়, তবে `count` বাড়ান।
3. ভিন্ন ক্যারেক্টার পেলে, বর্তমান ক্যারেক্টার এবং তার কাউন্ট (যদি ১-এর বেশি হয়) রেজাল্টে যোগ করুন।
...
4. লুপ চালিয়ে প্রতিটি ক্যারেক্টার চেক করুন:
   - যদি ক্যারেক্টার মিলে বা `?` হয়, তবে আগের ডায়াগোনাল ভ্যালু নিন।
   - যদি `*` হয়, তবে হয় `*` কে খালি স্ট্রিং হিসেবে ধরুন অথবা কোনো চরিত্রের সাথে মিলিয়ে নিন।
