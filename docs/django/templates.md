...
1. **Variables:** `variable` - ডেটা প্রিন্ট করার জন্য (যেমন: \{{ variable \}}).।
2. **Tags:** `tag` - লজিক (if/loop) এর জন্য (যেমন: `{% tag %}`)।
3. **Filters:** `value|filter` - ডেটা ফরম্যাট করার জন্য (যেমন: \{{ value|filter \}}).।
